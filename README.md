...
## <a name="docker-deployment">🐳 Docker Deployment</a>

This project includes Docker support for deployment to VPS servers with GitHub Container Registry.
...
- Deploys automatically to your VPS via SSH
...
- `VPS_APP_DIR` - Application directory (optional, defaults to /opt/stock-tracker)

**Setup:**
1. Add the required secrets in GitHub Settings → Secrets and variables → Actions
2. Ensure `GITHUB_TOKEN` has `packages: write` permission (enabled by default)
3. Push to main branch to trigger deployment
4. Access your app via reverse proxy (e.g., Caddy with TLS)

**Features:**
- 🏗️ Multi-stage Docker build for minimal image size
